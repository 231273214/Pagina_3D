...
return (
    <div className="character-container">
        ...
        <div className="character-info">
            <h2 className="character-title">Steven Universe</h2>
            <p className="character-description">
            Steven es el único híbrido conocido entre un humano y una gema. Hijo de Greg Universe y Rose Quartz. Su historia es símbolo de amor, identidad y esperanza.
            </p>
            <button
